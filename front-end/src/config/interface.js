...
export const urlGetProjectInfo = '/performance/getProjectInfo' // 获取工时申报详情
...
export const urlSavePMDataV2 = '/performance/savePMDataV2' // 写入绩效数据v2
export const urlSavePMDataV3 = '/performance/savePMDataV3' // 写入绩效数据v3
export const urlUpdatePMData = '/performance/updatePMData' // 更新绩效数据
export const urlUpdatePMDataV2 = '/performance/updatePMDataV2' // 更新绩效数据
export const urlUpdatePMDataV3 = '/performance/updatePMDataV3' // 更新绩效数据
...
export const urlGetWorkTimeListByType = '/performance/getWorkTimeListByType' // ***根据项目类型获取工时列表***
export const urlGetWorkHourStatistics = '/performance/getWorkHourStatistics' // ***获取工时统计（按组/按人/按项目类型）***
export const urlGetMonthProcess = '/performance/getMonthProcess' // ***根据项目阶段获取项目进展***
export const urlGetLatestProcessBeforeMonth = '/workStation/getLatestProcessBeforeMonth' // ***获取项目在某年某月之前的最近申报进展***
...
export const urlUpdateAssignProjectInfo = '/performance/updateAssignProjectInfo' // ***更新项目信息***
export const urlUpdateAssignProjectStageInfo = '/performance/updateAssignProjectStageInfo' // ***更新项目阶段信息***
export const urlGetAssignProjectTotalWorkTime = '/workStation/getAssignProjectTotalWorkTime' // ***获取项目总工时
...
export const urlAddFailedAMEvaData = '/achievementsEva/addFailedAMEvaData' // 添加失败成效评价数据
export const urlGetFailedAMEvaData = '/achievementsEva/getFailedAMEvaData' // 获取失败成效评价数据
export const urlGetAllFailedAMEvaData = '/achievementsEva/getAllFailedAMEvaData' // 获取所有失败成效评价数据（监控用）
export const urlUpdateFailedAMEvaRetrySuccess = '/achievementsEva/updateFailedAMEvaRetrySuccess' // 更新失败成效评价为重试成功
export const urlDeleteFailedAMEvaData = '/achievementsEva/deleteFailedAMEvaData' // 删除失败成效评价数据
export const urlClearFailedAMEvaData = '/achievementsEva/clearFailedAMEvaData' // 清除失败成效评价数据
...
export const urlGetCurMonthConclusionOverviewDataNewV3 = '/conclusion/getCurMonthConclusionOverviewDataNewV3' // 获取当月月总结中的下月计划

export const urlGetPMBDataByUserID = '/pmbData/getPMBDataByUserID' // **获取绩效加分数据(通过用户ID)
export const urlGetPBData = '/pmbData/getPBData' // **获取绩效加分数据
export const urlGetPMBRules = '/pmbData/getPMBRules' // **获取绩效加分标准
export const urlGetPMBRulesByID = '/pmbData/getPMBRulesByID' // **获取绩效加分标准(通过ID)
export const urlSubmitPBData = '/pmbData/submitPBData' // **提交绩效加分数据
export const urlUpdatePBData = '/pmbData/updatePBData' // **更新绩效加分数据

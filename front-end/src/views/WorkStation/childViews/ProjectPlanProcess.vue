      ...
      <el-table v-loading="!reqFlag.getAssignProjectDetail"
        ...
        <el-table-column label="项目进度" align="center">
          ...
          <el-table-column label="2月" align="center" prop="February" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.February'" :rules="formRules.February">
          ...
          <el-table-column label="3月" align="center" prop="March" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.March'" :rules="formRules.March">
          ...
          <el-table-column label="4月" align="center" prop="April" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.April'" :rules="formRules.April">
          ...
          <el-table-column label="5月" align="center" prop="May" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.May'" :rules="formRules.May">
          ...
          <el-table-column label="6月" align="center" prop="June" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.June'" :rules="formRules.June">
          ...
          <el-table-column label="7月" align="center" prop="July" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.July'" :rules="formRules.July">
          ...
          <el-table-column label="8月" align="center" prop="August" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.August'" :rules="formRules.August">
          ...
          <el-table-column label="9月" align="center" prop="September" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.September'" :rules="formRules.September">
          ...
          <el-table-column label="10月" align="center" prop="October" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.October'" :rules="formRules.October">
          ...
          <el-table-column label="11月" align="center" prop="November" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.November'" :rules="formRules.November">
          ...
          <el-table-column label="12月" align="center" prop="December" width="73%">
            <template slot-scope="scope">
              <el-form-item :prop="'tableData.' + scope.$index + '.December'" :rules="formRules.December">
      ...
      methods: {
        ...
        genWorkTimeApply () {
          ...
          this.httpGetAssignProjectDetail(this.$route.query.projectID, year).then(res => {
            ...
            this.getMonthProcess().then(res1 => {
